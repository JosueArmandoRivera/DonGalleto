...
$(document).ready(function () {
    ...
    $(".fechas-frecuente").hide();
    $("#tabla-dias").hide();
    $("#tipoPase").on("change", function () {
...
$(document).on("click", "#btnNuevoUsuario", () => {     //Cuando se le da click al botón de nuevo ejemplo 
    ...
    objeto.verModal("Registrar Visita");       //Llamamos al metodo de vermodal para visualizar el modal
...
$(document).on("click", "#btnAgregar", function() {       //Cuando se le da click al boton de agregar
    ...
    $("#formularioVisitas").validate().destroy();    //Destruimos la validacion del formulario, ya que si no hacemos esto la instancia de validacion se queda guardada en la cache y es como si se repitiera este metodo
    $("#formularioVisitas").validate({               //Comenzamos la validacion del formulario
        ignore: [],
