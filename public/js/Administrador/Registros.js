/* Creado por: Armando Rivera
   ...
   let btnModal = {
    ...
    "btnEditar": document.getElementById("btnEditarModalRegistros"),      //Agregamos el boton de editar
};
let modal = document.getElementById("modalRegistros");         //Guardamos el modal que utilizaremos en una variables
let formulario = document.getElementById("formularioRegistros");   //Guardamos en una variable el formulario a utilzar
let objeto = new Peticion("/registros/armarTabla", modal, btnModal, formulario);//Creamos el objeto de tipo peticion y le mandamos las variables ya creadas
...
$(document).on("click", "#btnNuevoRegistro", () => {     //Cuando se le da click al botón de nuevo ejemplo 
...
$(document).on("click", "#btnCerrarModalRegistros", () => {      //Cuando se le d eclick al boton de cerrar modal
...
$(document).on("click", "#btnAgregar", () =>{       //Cuando se le da click al boton de agregar
    ...
    $("#formularioRegistros").validate().destroy();    //Destruimos la validacion del formulario, ya que si no hacemos esto la instancia de validacion se queda guardada en la cache y es como si se repitiera este metodo
    $("#formularioRegistros").validate({               //Comenzamos la validacion del formulario
        ignore: [],
