...
class UpdateRequest extends FormRequest
{
    ...
    public function messages()
    {
        return [
            ...
            "descripcion.required" => "Se necesita ingresar una descripción",
            //Si el atributo nombreUnidadAdministrativa no cumple con la expresion regular se muestra el siguiente mensaje
            "descripcion.regex" => "La descripción introducida contiene carácteres no permitidos. Algunos de los carácteres permitidos son _ ! ¡ ? ¿ { } $ ^ - ' + * & % # °",
