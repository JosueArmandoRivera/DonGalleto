...
class UpdateRequest extends FormRequest
{
    ...
    {
        return[
            "idUsuario.required" => "Se necesita ingresar un Usuario",
            "idUsuario.integer" => "El ID de Usuario debe ser un número entero",
            ...
            "idRol.required" => "Se necesita seleccionar un tipo de proveedor",
            //si el atributo Id_Rol no cuenta con el requerido se muestra el siguiente mensaje
            "idRol.integer" => "El ID de proveedor debe ser un número entero",
            "idArea.required" => "Se necesita ingresar un Área",
            "idArea.integer" => "El ID de Area debe ser un número entero",
