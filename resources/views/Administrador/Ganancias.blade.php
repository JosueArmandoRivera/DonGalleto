...
<head>
    ...
    <!-- Custom CSS -->
    <link rel="stylesheet" href="/css/Administrador/Ganancias.css">
</head>
...
<div class="container mt-1">
    ...
    <div class="card-header d-flex justify-content-between align-items-center" style="background: #e6b31b;">
            <h3 class="text-light">Registros de Ventas</h3>
        </div>
...
<script src="/js/Administrador/ganancias.js"></script>
